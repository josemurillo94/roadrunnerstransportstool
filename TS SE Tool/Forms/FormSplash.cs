...
namespace TS_SE_Tool
{
    public partial class FormSplash : Form
    {
        ...
        {
            string url = "https://discord.gg/GRzEjGW";
            System.Diagnostics.Process.Start(url);
        }

        private void linkSecond_Click(object sender, EventArgs e)
        {
            string url = "https://www.roadrunnerstransports.com";
            System.Diagnostics.Process.Start(url);
        }
        ...
        private void labelDownloadDescription_Click(object sender, EventArgs e)
        {
        ...
        private void linkFirst_LinkClicked_1(object sender, LinkLabelLinkClickedEventArgs e)
        {
            string url = "https://discord.gg/GRzEjGW";
            System.Diagnostics.Process.Start(url);
        }

        private void linkSecond_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            string url = "https://www.roadrunnerstransports.com";
            System.Diagnostics.Process.Start(url);
        }
